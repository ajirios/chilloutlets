 ...
 * @author mac
 */
@WebServlet(name = "InsuranceServlet", urlPatterns = {"/InsuranceServlet"})
...

{
    ...
    
    {
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        File contextFile = new File(outletsPath + File.separator + "insurances/" + fileName);
                        ...
                        request.setAttribute("message",
                            "Upload has been done successfully to " + outletsPath + File.separator + "insurances/" + fileName);
        ...
        {
            Logger.getLogger(InsuranceServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
