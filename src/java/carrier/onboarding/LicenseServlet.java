 ...
 * @author mac
 */
@WebServlet(name = "LicenseServlet", urlPatterns = {"/LicenseServlet"})
...

{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet LicenseServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        File contextFile = new File(outletsPath + File.separator + "licenses/" + fileName);
                        ...
                        request.setAttribute("message",
                            "Upload has been done successfully to " + outletsPath + File.separator + "licenses/" + fileName);
