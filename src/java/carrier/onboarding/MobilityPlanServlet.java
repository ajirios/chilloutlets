 ...
 * @author mac
 */
@WebServlet(name = "MobilityPlanServlet", urlPatterns = {"/MobilityPlanServlet"})
public class MobilityPlanServlet extends HttpServlet 

{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MobilityPlanServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MobilityPlanServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    
    {
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        File contextFile = new File(outletsPath + File.separator + "mobility/" + fileName);
            ...
            
        {
            ...
            if (names[count].equalsIgnoreCase("photo-post-client-id"))

            {
                //clientID = Long.parseLong(values[count]);
            }

            else if (names[count].equalsIgnoreCase("photo-post-message"))

            {
                //message = values[count];
            }

            else if (names[count].equalsIgnoreCase("photo-post-board-id"))
        ...
        response.sendRedirect("onboarding/carrier/app.jsp");
    }
