 ...
 * @author mac
 */
@WebServlet(name = "SINCardServlet", urlPatterns = {"/SINCardServlet"})
public class SINCardServlet extends HttpServlet 

{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SINCardServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SINCardServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
            ...
            
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        File contextFile = new File(outletsPath + File.separator + "sins/" + fileName);
