...
import carrier.onboarding.CarrierRegisterServlet;
 ...
 * @author mac
 */
@WebServlet(name = "StoreRegisterServlet", urlPatterns = {"/StoreRegisterServlet"})
...

{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet StoreRegisterServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet StoreRegisterServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    
    {
            ...
            
        {
            ...
            session.setAttribute("outlet-number", carrierID);
            session.setAttribute("branch-number", carrierID);
