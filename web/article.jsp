<%-- 
    Document   : outlet
    Created on : 3-Sep-2018, 12:54:26 PM
    Author     : mac
--%>
		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				<header id="header">
					...
					<nav id="nav">
						<ul>
							<li><a href="index.html">My Closet</a></li>
			...
			<!-- Main -->
				<section id="main" class="container">
					<header>
						<h2>Learning all about Music</h2>
						<p>Skilled musicians use instruments to bring joy to others.</p>
					</header>
					<div class="box">
						<span class="image featured"><img src="images/adorama.jpg" alt="" /></span>
