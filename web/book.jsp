<%-- 
    Document   : stores
    Created on : 20-Sep-2018, 3:34:36 AM
    Author     : ajirios
--%>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <%
        ...
        session.setAttribute("current-page", "book.jsp");
            ...
            <div class="panel-area">
              ...
              <div class="explore-panel">
                    ...
                    <div class="outlets">
                        ...
                        <div class="outlet-store">
                            <a href="javascript:selectOutlet('<%= outlets.getOutlet(count).getOutletNumber() %>', '<%= outlets.getOutlet(count).getBranchNumber() %>', '<%= outlets.getOutlet(count).getOutletName().replace("'", "\\'") %>', '<%= outlets.getOutlet(count).getBranchAddress().replace("'", "\\'") %>', '<%= outlets.getOutlet(count).getOutletPoster() %>')">
                                ...
                                <div class="delivery-time"><span class="toptext">Delivery Time</span>
                                <br><span class="bottomtext"><%= outlets.getOutlet(count).getDeliveryTime() %></span>
                                </div>
                                <div class="delivery"><span class="toptext">Delivery Fee</span><br><span class="bottomtext"><%= outlets.getOutlet(count).getTransitFee() %></span></div>
                ...
                <div class="order-panel">
                    ...
                    <div class="subtotal-checker"><div class="checker">Stores in ticket</div><div class="subtotal"><span id="subtotal-double">5</span></div></div>
                    <div class='checkout-area'><button onclick="shop()" class="checkout-button">VISIT STORES</button></div>
