<%-- 
    Document   : app
    Created on : 28-Nov-2018, 1:44:50 AM
    Author     : ajirios
    Description: Get app download verification details for schedule to begin.
--%>
...
.container .checkmark:after {
    ...
    <div class="paper">
        ...
        <%
            ...
            <div class="document-identifier">Carrier App</div>
            ...
            <div class="">
            Once you've installed the app and completed your first sign-in, your app will be prompted to move forward to the 
            next step in your application process.
            </div>
            
            
            <form id="welcome-form" method="post" action="../../AppInstallServlet">
            
                <br><br>
        <p>
            <label class="container">I have installed the Google Play Carrier App and signed in.
                <input type="radio" name="app-installed">
        ...
        <div class="redclickarea">
            <button class="redclicker">SUBMIT</button>
        </div>
