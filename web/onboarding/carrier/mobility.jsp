...
.container .checkmark:after {
    ...
    <div class="paper">
        ...
        <div id="work-permit" class="work-permit">
            ...
            <div class="document-identifier">Carrier Mobility Plan</div>
        ...
        <form id="mobility-form" method="post" enctype="multipart/form-data" action="../../MobilityPlanServlet">
            
        
            
            <div class="">
            To start fulfilling orders and earning money on our Carrier App, you need to have an Android 
            mobile device that is enabled with a data plan. Android mobile devices are easy to obtain.
            </div>
            
            <div class="document-identifier">Android mobile platform is enabled by default.</div>
            ...
            <div class="document-identifier">Please select your mobile device OEM.</div>
            ...
            <div class="document-identifier">Please select your mobile carrier network provider.</div>
            ...
            <div class="document-identifier">How much does this plan cost you monthly?</div>
            
            <div class="">
                <input required type="number" style="width:100%;" placeholder="CAD$" />
            </div>
            
            <div class="document-identifier">Please enter the mobile phone number.</div>
            
            <div class="">
                <input required type="number" style="width:100%;" />
            </div>
            ...
            <div class="document-identifier">Please upload a copy of a phone bill or contract.</div>
            
                    <div hidden><input required id="bill-upload-button" type="file" name="uploadFile" /></div>
                    <a href="javascript:clickBillUpload()">
...
<script type="text/javascript">
        ...
        $("#bill-upload-button").on('change', function () {
        ...
        function clickBillUpload()
        
        {
            document.getElementById('bill-upload-button').click();
        }
        
        function submitForm()
        
        {
            document.getElementById('mobility-form').submit();
