<%-- 
    Document   : call
    Created on : 28-Nov-2018, 1:45:05 AM
    Author     : ajirios
    Description: Get a call from the team to schedule first shifts and procedures.
--%>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <div class="step-holder">
        ...
        <div class="step-body">
            ...
            <div class="step">
                ...
                <div class="step-section current">Screening</div>
    ...
    <div class="paper">
        ...
        <span>Please stand by while we review and verify all your documents. Your account will be set to active, and you will be reached
             by phone or email when the screening 
        process is complete!</span>
