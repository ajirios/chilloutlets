...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <div class="paper">
        ...
        <h3>WELCOME TO CARRIER ONBOARDING</h3><br><br>
            
        
        <p>Please make sure that the photo is clear 
            and the expiration date is visible. Photos that are difficult to read may delay your application.
            Please make sure that the photo is clear 
            and the expiration date is visible. Photos that are difficult to read may delay your application.
        </p>
