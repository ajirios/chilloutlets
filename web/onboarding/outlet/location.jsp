<%-- 
    Document   : location
    Created on : 25-Dec-2018, 1:31:12 AM
    Author     : mac
--%>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <div class="step-holder">
        ...
        <div class="step-body">
            ...
            <div class="step">
                ...
                <div class="step-section">Telephone</div>
                <div class="step-line"></div>
            </div>
            
            <div class="step">
                <div class="step-round">3</div>
                <div class="step-section">Hours</div>
                <div class="step-line"></div>
            </div>
    ...
    <div class="paper">
        ...
        <div id="work-permit" class="work-permit">
            ...
            <div class="document-identifier">Outlet | Store Location</div>
        ...
        <form id="bank-account-form" method="post" enctype="multipart/form-data" action="../../StoreLocationServlet">
            
        
            
            <div class="">
            To be able to create a mobile entrepot of your store with the network, you will need to enter the store's 
            elementary and architecture information such as posters, banners, and product description.
            </div>
            <br>
            
            <div class="instructions">
            Make sure that the photo is clear and crisp. 
            Photos that are difficult to see may delay your application.
            </div>
            
            <div class="document-identifier">Please upload your outlet logo (At least 200px x 200px).</div>
            ...
            <div class="document-identifier">Please upload your outlet banner (At least 200px x 2500px).</div>
            ...
            <div class="document-identifier">What is your outlet created for? (Please provide a short description.)</div>
            
            <textarea rows="3" cols="54" class="" placeholder="Short description (500 characters)"></textarea>
            
            
            <div class="document-identifier">What products does it sell? (Please select all that apply.)</div>
            
            <div class="">
                <select required="required" style="width:100%;" size='7' multiple>
                    <option value='rbc'>Appliances</option>
                    <option value='td'>Apparel</option>
                    <option value='cibc'>Electronics</option>
                    <option value='scotiabank'>Groceries</option>
                    <option value='bmo'>Convenience goods</option>
                    <option value='tangerine'>Shoes</option>
                    <option value='hsbc'>Toys</option>
                    <option value='rbc'>Appliances</option>
                    <option value='td'>Apparel</option>
                    <option value='cibc'>Electronics</option>
                    <option value='scotiabank'>Groceries</option>
