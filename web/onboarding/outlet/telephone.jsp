<%-- 
    Document   : telephone
    Created on : 24-Dec-2018, 9:43:12 PM
    Author     : mac
--%>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <div class="paper">
        ...
        <div id="banking-debit" class="banking-debit">
            ...
            <div class="document-identifier">Outlet | Telephone Number</div>
        ...
        <form id="credit-card-form" method="post" action="../../StoreTelephoneServlet">
            
        
            
            <div class="">
            To be able to conduct better business with the network, we need the store's telephone number, 
            so that we can reach you when we need to.
            </div>
            <br>
            
            <div class="document-identifier">Please enter your store telephone number.</div>
            
            <div class="">
                <input type="text" style="width:100%;" placeholder="Telephone #" />
            </div>
            <br>
